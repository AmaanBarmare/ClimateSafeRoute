    ...
    <main className="relative overflow-x-hidden">
      ...
      <section className="relative min-h-[100svh] flex flex-col">
        ...
        <nav className="relative z-10 flex items-center justify-between px-6 md:px-10 py-6">
          <div className="flex items-center gap-3">
            ...
            <span className="font-display text-lg tracking-tight text-slate-100">
              ClimateSafe<span className="text-emerald-300"> · </span>Route
            </span>
          </div>
          <div className="hidden md:flex items-center gap-8 text-sm text-slate-300/80">
            <a href="#how" className="hover:text-white transition-colors">How it works</a>
            <a href="#data" className="hover:text-white transition-colors">Climate data</a>
            <a href="#faq" className="hover:text-white transition-colors">FAQ</a>
          </div>
          <Link
            href="/app"
            className="group inline-flex items-center gap-2 rounded-full bg-emerald-400 hover:bg-emerald-300 text-slate-950 font-semibold text-sm px-5 py-2.5 transition-colors"
          >
            Open the app
        ...
        <div className="relative z-10 flex-1 flex items-center px-6 md:px-10">
          <div className="max-w-5xl w-full pb-24 pt-8">
            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] backdrop-blur px-3 py-1.5 text-[11px] uppercase tracking-[0.22em] text-emerald-200/90 animate-fade-up">
              <span className="h-1.5 w-1.5 rounded-full bg-emerald-400 animate-pulse" />
              Live in NYC · Manhattan + Brooklyn
            </div>

            <h1
              className="font-display font-light text-white mt-6 leading-[0.95] tracking-tight text-[clamp(2.5rem,7vw,6rem)] animate-fade-up"
              style={{ animationDelay: "120ms" }}
            >
              The shortest path
              <br />
              isn't the <span className="italic text-emerald-300">coolest</span>.
            </h1>

            <p
              className="mt-7 max-w-xl text-slate-200/85 text-base md:text-lg leading-relaxed animate-fade-up"
            ...
            >
              <Link
                href="/app"
                className="group inline-flex items-center justify-center gap-2 rounded-full bg-emerald-400 hover:bg-emerald-300 text-slate-950 font-semibold text-base px-7 py-4 transition-colors shadow-[0_10px_40px_-10px_rgba(52,211,153,0.6)]"
              >
                Plan a cooler walk
              ...
              <a
                href="#how"
                className="inline-flex items-center justify-center gap-2 rounded-full border border-white/15 hover:border-white/30 bg-white/[0.04] hover:bg-white/[0.08] text-slate-100 font-medium text-base px-6 py-4 backdrop-blur transition-colors"
              >
                See how it works
              </a>
            </div>
        ...
        {/* Scroll cue */}
        <div className="relative z-10 pb-8 flex items-center justify-center text-[10px] uppercase tracking-[0.3em] text-slate-400/70">
          <div className="flex items-center gap-3">
            <span>Scroll</span>
            <span className="h-[1px] w-10 bg-slate-500/60" />
          </div>
        </div>
      </section>
      ...
      <section id="how" className="relative px-6 md:px-10 py-24 md:py-36">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="font-display font-light text-4xl md:text-6xl leading-[1.02] tracking-tight max-w-3xl mt-4">
            Two routes, side by side.
            <br />
            <span className="italic text-emerald-300">You choose the tradeoff.</span>
          </h2>
      ...
      {/* ═══════════════════════ DATA STRIP ═══════════════════════ */}
      <section id="data" className="relative px-6 md:px-10 py-20 border-y border-white/5 bg-gradient-to-b from-[#070d1c] to-[#060a16]">
        <div className="max-w-6xl mx-auto">
      ...
      <section className="relative px-6 md:px-10 py-24 md:py-32">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h3 className="font-display font-light text-3xl md:text-5xl leading-[1.05] tracking-tight mt-4">
      ...
      <section id="faq" className="relative px-6 md:px-10 py-24">
        <div className="max-w-3xl mx-auto">
          ...
          <h3 className="font-display font-light text-3xl md:text-5xl leading-tight tracking-tight mt-4">
            Things people ask.
          </h3>
      ...
      <section className="relative px-6 md:px-10 py-28 md:py-36">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <h3 className="font-display font-light text-4xl md:text-7xl leading-[0.98] tracking-tight">
            Pick a cooler<br />
            <span className="italic text-emerald-300">way home.</span>
          </h3>
          ...
          <Link
            href="/app"
            className="group inline-flex mt-10 items-center gap-2 rounded-full bg-emerald-400 hover:bg-emerald-300 text-slate-950 font-semibold text-base px-8 py-4 transition-colors shadow-[0_20px_60px_-20px_rgba(52,211,153,0.6)]"
          >
      ...
      {/* ═══════════════════════ FOOTER ═══════════════════════ */}
      <footer className="relative px-6 md:px-10 pt-12 pb-10 border-t border-white/5">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-6 md:items-end md:justify-between">
          <div className="flex items-center gap-3">
            <Logo />
            <div>
              <div className="font-display text-base tracking-tight text-slate-100">
                ClimateSafe<span className="text-emerald-300"> · </span>Route
              </div>
          ...
          <div className="text-xs text-slate-500 flex flex-wrap gap-x-6 gap-y-2">
            ...
            <a className="hover:text-slate-300" href="https://www.openstreetmap.org/copyright">© OpenStreetMap</a>
            <a className="hover:text-slate-300" href="https://www.mapbox.com/about/maps/">© Mapbox</a>
          </div>
        </div>
      </footer>
    </main>
...
function Logo() {
  return (
    <div className="relative h-9 w-9 rounded-xl bg-gradient-to-br from-emerald-400/30 to-emerald-500/10 border border-emerald-300/30 grid place-items-center shadow-[0_0_24px_-8px_rgba(52,211,153,0.6)]">
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
        <path
          ...
          fill="none"
        />
        <circle cx="2.4" cy="14" r="1.4" fill="#34d399" />
        <circle cx="16" cy="4" r="1.4" fill="#34d399" />
      </svg>
    </div>
  );
}
...
function SectionLabel({ children }: { children: React.ReactNode }) {
  return (
    <div className="inline-flex items-center gap-3 text-[11px] uppercase tracking-[0.3em] text-emerald-300/80">
...
function Step({ n, title, body }: { n: string; title: string; body: string }) {
  return (
    <li className="relative pl-14 pr-2 py-4 group">
      <span className="absolute left-0 top-4 font-mono text-xs text-emerald-300/80 tracking-widest">
        {n}
      </span>
      <span className="absolute left-9 top-5 h-px w-3 bg-emerald-300/40" />
      <h4 className="font-display text-xl text-white">{title}</h4>
      <p className="text-slate-400 mt-1.5 text-sm leading-relaxed">{body}</p>
    </li>
  );
}
...
function DataCard({
  ...
  const toneMap = {
    orange: { ring: "rgba(249,115,22,0.4)", glow: "rgba(249,115,22,0.18)", text: "text-orange-300" },
    blue: { ring: "rgba(59,130,246,0.4)", glow: "rgba(59,130,246,0.18)", text: "text-sky-300" },
    emerald: { ring: "rgba(52,211,153,0.4)", glow: "rgba(52,211,153,0.18)", text: "text-emerald-300" },
  }[tone];

  return (
    <div
      className="relative rounded-3xl border border-white/10 bg-white/[0.02] p-7 overflow-hidden group hover:border-white/20 transition-colors"
    ...
    >
      ...
      <div className="relative flex items-center justify-between">
        <span
          className={`text-[10px] uppercase tracking-[0.22em] font-medium ${toneMap.text}`}
        >
          {tag}
        </span>
        <span
          className="h-2.5 w-2.5 rounded-full"
          style={{ background: toneMap.ring }}
        />
      </div>
      <h4 className="relative font-display text-2xl md:text-[26px] text-white mt-5 leading-snug">
        {title}
      </h4>
      <p className="relative text-slate-400 text-sm mt-3 leading-relaxed">
        {body}
      </p>
...
function CompareCard() {
  return (
    <div className="relative rounded-3xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-white/[0.01] p-1">
      <div className="rounded-[22px] bg-[#080e1d] p-7">
        <div className="flex items-center justify-between text-[11px] uppercase tracking-[0.22em] text-slate-400">
          ...
          <span className="font-mono text-emerald-300/90">/route</span>
        </div>
        ...
        <div className="mt-7 rounded-2xl border border-emerald-300/15 bg-emerald-400/[0.04] p-4">
  ...
  return (
    <div
      className={`grid grid-cols-12 gap-3 items-center rounded-xl px-3 py-3 ${
        highlight ? "bg-emerald-400/[0.06] ring-1 ring-emerald-300/20" : ""
      }`}
    >
...
function Bullet({ children }: { children: React.ReactNode }) {
  return (
    <li className="flex gap-3">
      <span className="mt-2.5 h-1.5 w-1.5 rounded-full bg-emerald-400 shrink-0" />
      <span>{children}</span>
    </li>
  );
}
  ...
  return (
    <details className="group py-5">
      <summary className="flex cursor-pointer items-center justify-between gap-6 list-none">
        <span className="font-display text-lg md:text-xl text-white">{q}</span>
        <span className="h-7 w-7 rounded-full border border-white/15 grid place-items-center text-slate-300 group-open:rotate-45 transition-transform">
          <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
            <path d="M5 1v8M1 5h8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
          </svg>
        </span>
      </summary>
      <p className="text-slate-400 mt-3 text-sm md:text-base leading-relaxed pr-12">
        {children}
      </p>
    </details>
  );
